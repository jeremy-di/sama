            ...
            <div className='ml-64'>
                ...
                <div className="w-full p-5 m-auto max-w-5/6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mb-5">
                    <div className="flex flex-col items-center pb-10">
                        ...
                        <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white"><span className='text-red-600'>Etudiant ayant créer le médecin : </span>{medecin.secretary.login}</h5>

                        <div className="flex mt-4 md:mt-6">
                            <a className='focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800' href="/formateur/listmedecins">Retour</a>
...
export default FormateurOneMedecin;