            ...
            <div className='ml-64'>
                ...
                <div className="w-full p-5 m-auto max-w-5/6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mb-5">
                    <div className="flex flex-col items-center pb-10">
                        ...
                        <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white"><span className='text-red-600'>Etudiant ayant créer le dossier : </span>{patient.secretary.login}</h5>
                    </div>
                </div>
                {/*  */}
                {/*  */}
                <div className="w-full p-5 m-auto max-w-5/6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    <div className="flex flex-col items-center pb-10">
...
export default FormateurOnePatient;