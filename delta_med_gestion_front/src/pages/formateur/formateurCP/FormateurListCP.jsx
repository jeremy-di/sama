            ...
            <div className='ml-64'>
                ...
                <div className="space-y-3 md:hidden">
                    ...
                    <div key={index} className="rounded-lg border p-4 bg-white dark:bg-gray-800">
                        ...
                        <div className="mt-1 text-sm text-gray-600">{caisse.secretary.login}</div>
                    </div>
                    ))}
                </div>
                ...
                <table className="min-w-full text-sm text-left rtl:text-right text-gray-700">
                    ...
                    <tr key={index} className="bg-white dark:bg-gray-800">
                        ...
                        <td className="px-6 py-4 font-medium text-gray-900 dark:text-white">{caisse.secretary.login}</td>
...
export default FormateurListCP;