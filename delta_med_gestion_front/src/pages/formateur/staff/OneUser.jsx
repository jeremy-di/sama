...
const OneUser = () => {
    ...
    if ( !loaded ) {
        ...
        return (
            <div>
                <h1 className='text-4xl text-center mt-5 mb-5'>Profil de {user.login}</h1>
                <section class="bg-white dark:bg-gray-900">
                    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                        <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                            <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                                <a href="#">
                                    <img class="w-1/2 rounded-lg sm:rounded-none sm:rounded-l-lg" src="/images/users.png" alt="Bonnie Avatar"/>
                                </a>
                                <div class="p-5">
                                    <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">ROLE : {user.role}</p>    
                                </div>
                            </div> 
