...
const UpdateCP = () => {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        socialSecurityService.updateSocialSecurity(id, {
    ...
    <div>
        ...
        <div className='text-center mt-5'>
            <a className='focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900' href="/caisseprimaire/list">Retour</a>
        </div>
    </div>
    );
};
