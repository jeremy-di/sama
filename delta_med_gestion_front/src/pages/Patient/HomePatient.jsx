...
const HomePatient = () => {
    return (
        <div>
            <h1 className='text-4xl text-center mt-5 mb-5 text-sky-800'>Patients</h1>
            ...
            <div className='h-screen sm:block w-1/2 m-auto lg:flex items-center justify-center gap-5'>
                ...
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mb-5">
                    <a href="/patient/list">
                        ...
                        <div class="p-5">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Liste</h5>
                        </div>
                    </a>
                </div>
            </div>
